...
export const negociosData = [
  // Plan Free
  {
    ...
    descripcion:
      "Los mejores tacos al pastor de Iztapalapa, con más de 20 años de tradición familiar.",
  ...
  },
  {
    ...
    descripcion:
      "Farmacia de confianza con medicamentos genéricos y de patente, atención personalizada.",
    categoria: "Salud",
  ...
  },
  {
    ...
    descripcion:
      "Servicios de belleza integral: cortes, peinados, manicure, pedicure y tratamientos faciales.",
    categoria: "Belleza",
  ...
  // Plan Profesional
  {
    ...
    descripcion:
      "Cocina mexicana auténtica con platillos tradicionales de la región. Ambiente familiar y precios accesibles.",
    categoria: "Restaurantes",
    slug_categoria: "restaurantes",
    ...
    mapa_embed_url:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3764.8",
  ...
  },
  {
    ...
    descripcion:
      "Servicios dentales integrales con tecnología de vanguardia. Especialistas en ortodoncia e implantes.",
    categoria: "Salud",
    slug_categoria: "salud",
    ...
    mapa_embed_url:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3764.9",
  ...
  },
  {
    ...
    descripcion:
      "Salón de belleza premium con servicios especializados en colorimetría, extensiones y tratamientos capilares.",
    categoria: "Belleza",
    slug_categoria: "belleza",
    ...
    mapa_embed_url:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3765.0",
  ...
  // Plan Premium
  {
    ...
    descripcion:
      "Especialistas en mariscos frescos y cocina del mar. El mejor sabor del océano en el corazón de Iztapalapa.",
    categoria: "Restaurantes",
    slug_categoria: "restaurantes",
    ...
    mapa_embed_url:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3765.1",
  ...
  },
  {
    ...
    descripcion:
      "Centro médico de especialidades con consultorios equipados y laboratorio clínico. Atención médica de calidad.",
    categoria: "Salud",
    slug_categoria: "salud",
    ...
    mapa_embed_url:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3765.2",
    ...
    hours:
      "Lunes a Viernes: 7:00 AM - 9:00 PM, Sábado: 8:00 AM - 6:00 PM, Domingo: 9:00 AM - 3:00 PM",
    services: [
      "Medicina general",
      "Especialidades",
      "Laboratorio",
  ...
  },
  {
    ...
    descripcion:
      "Spa de lujo con tratamientos relajantes, masajes terapéuticos y servicios de bienestar integral.",
    categoria: "Belleza",
    slug_categoria: "belleza",
    ...
    mapa_embed_url:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3765.3",
...
export const getNegociosPorCategoria = (slug) => {
  return negociosData.filter(
    (negocio) => negocio.slug_categoria === slug && !negocio.is_deleted
  );
};

// Función para obtener negocio por slug
export const getNegocioPorSlug = (slug) => {
  return negociosData.find(
    (negocio) => negocio.slug === slug && !negocio.is_deleted
  );
};
...
export const getNegociosDestacados = () => {
  return negociosData.filter(
    (negocio) => negocio.is_featured === true && !negocio.is_deleted
  );
};
...
export const getNegociosOrdenados = () => {
  ...
  return negociosData
    .filter((negocio) => !negocio.is_deleted)
    .sort((a, b) => orden[a.plan_type] - orden[b.plan_type]);
};
